...
;
	...
	cmp AL,'z'	; compare the character in AL to the character 'z'
	JG skipPrint	; if the value is larger than 'z', skip the printing command

	cmp AL,'a'	; compare the character in AL to the character 'a'
	JL skipPrint	; if the value is smaller than 'a', skip the printing command
