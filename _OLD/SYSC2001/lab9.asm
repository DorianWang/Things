...
MENT:	.DB 0		; Representation of normalized number
...
normalizeNumber:
	...
	loopBackNormalize:
	SHL BL, 1
	JC finishShiftingNormalize
	cmp AL, 0
	je finishShiftingNormalize ;Avoids infinite loops
	DEC AL
	jmp loopBackNormalize
...
Message1: .DB	'Enter a signed num (up to +- 30): $'		; FIX ME -- Message to be printed on screen
	Message2part1: .DB	'In normalized form: $'
	Message2part2: .DB	' x 2^$'
	Message3: .DB	'In quarter precision IEEE-754: $'  
